...
This version requires at least version 0.2.6-RC4 of Dynamips.
...
* Ghost size is automatically calculated. Use of the "ghostsize" option should no longer be necessary. Thanks to this and the previous bugfix, I don't think there are any situations (other than using uncompressed images) that should cause ghostios to break otherwise functioning labs. 
